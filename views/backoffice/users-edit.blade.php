...
@section('content')
  <div class="pageheader">
    <h2>{{ $page['parent'] }} <span>Edit {{ $page['name'] }}</span></h2>
  ...
  <div class="contentpanel">
      <div class="row">
      <div class="col-md-12">
        <form id="TheForm" method="post" action="{{ route($ctrl.':update', ['id' => $id]) }}" ajax-form="true" class="form-horizontal">
          <div class="panel panel-dark">
            <div class="panel-heading">
              <h4 class="panel-title">Edit {{ $page['name'] }}</h4>
            </div>
            <div class="panel-body">
              ...
              <div class="form-group">
                ...
                <div class="col-sm-3">
                  <input name="bu_real_name" value="{{ $row['bu_real_name'] }}" type="text" class="form-control" placeholder="{{ $lang['bu_real_name'] }}"/>
                </div>
              </div>
              ...
              <div class="form-group">
                ...
                <div class="col-sm-3">
                  <input name="bu_init" value="{{ $row['bu_init'] }}" type="text" class="form-control" placeholder="{{ $lang['bu_init'] }}"/>
                </div>
              </div>
              ...
              <div class="form-group">
                ...
                <div class="col-sm-3">
                  <input name="bu_email" value="{{ $row['bu_email'] }}" type="text" class="form-control" placeholder="{{ $lang['bu_email'] }}"/>
                </div>
              </div>
              ...
              <div class="form-group">
                ...
                <div class="col-sm-3">
                  <input name="bu_name" value="{{ $row['bu_name'] }}" type="text" class="form-control" placeholder="{{ $lang['bu_name'] }}"/>
                </div>
              </div>

              <div class="form-group">
                <label class="col-sm-2 control-label">{{ $lang['bu_passwd'] }}</label>
                <div class="col-sm-3">
              ...
              <div class="form-group">
                ...
                <div class="col-sm-3">
                  {{ select('bu_level', $module_access_select, $row['bu_level'], 'class="chosen-select"') }}
                </div>
              </div>
              ...
              <div class="form-group">
                ...
                <div class="col-sm-1">
                  <div class="rdio rdio-success">
                    <input type="radio" name="status" value="y" id="rad_active" {{ $status == "y" ? "checked" : "" }}>
                ...
                <div class="col-sm-2">
                  <div class="rdio rdio-danger">
                    <input type="radio" name="status" value="n" id="rad_inactive" {{ $status == "n" ? "checked" : "" }}>

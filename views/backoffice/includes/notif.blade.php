  ...
  <div class="btn-group">
    ...
    <div class="dropdown-menu dropdown-menu-head pull-right">
      ...
      <ul class="dropdown-list gen-list">
        <li class="new">
          <a href="#">
          <span class="thumb"><img src="<?php echo assets('bo.images');?>/photos/user4.png" alt="" /></span>
          <span class="desc">
        ...
        <li class="new">
          <a href="#">
          <span class="thumb"><img src="<?php echo assets('bo.images');?>/photos/user5.png" alt="" /></span>
          <span class="desc">
        ...
        <li class="new">
          <a href="#">
          <span class="thumb"><img src="<?php echo assets('bo.images');?>/photos/user3.png" alt="" /></span>
          <span class="desc">

                ...
                <div class="col-md-10">
                    <div class="product-content-right">
                        <div class="woocommerce">
                            <div class="woocommerce-info ">Success Update Data!
                            </div>
                            ...
                            <form enctype="multipart/form-data" action="#" class="checkout" method="post" name="checkout">
                                    ...
                                    <div class="col-2">
                                        <div class="woocommerce-billing-fields">
                                            ...
                                            <p id="billing_last_name_field" class="form-row form-row-last validate-required">
                                                ...
                                                <input type="text" value="" placeholder="No Telepon/ Handphone" id="billing_last_name" name="billing_last_name" class="input-text ">
                                            </p>

                                            <p id="billing_last_name_field" class="form-row form-row-last validate-required">
                                                <label class="" for="billing_last_name">Alamat </label>
                                                <input type="text" value="" placeholder="Alamat Email" id="billing_last_name" name="billing_last_name" class="input-text ">
                                            </p>

                                            <p id="billing_last_name_field" class="form-row form-row-last validate-required">
                                                <label class="" for="billing_last_name">Kota </label>
                                                <input type="text" value="" placeholder="Kota" id="billing_last_name" name="billing_last_name" class="input-text ">
                                            </p>

                                            <p id="billing_last_name_field" class="form-row form-row-last validate-required">
                                                <label class="" for="billing_last_name">Provinsi </label>
                                                <input type="text" value="" placeholder="Provinsi" id="billing_last_name" name="billing_last_name" class="input-text ">
                                            </p>

                                            <p id="billing_last_name_field" class="form-row form-row-last validate-required">
                                                <label class="" for="billing_last_name">Kode Pos </label>
                                                <input type="text" value="" placeholder="Kode Pos" id="billing_last_name" name="billing_last_name" class="input-text ">
                                            </p>
                                        </div>
                                    </div>
                                </div>
                                <div id="order_review" style="position: relative;">
                                    <div id="payment">
                                        ...
                                        <input type="submit" data-value="Place order" value="Login Account" id="place_order" name="woocommerce_checkout_place_order" class="button alt">
                                        </div>
                                        <div class="clear"></div>
                                    </div>
                                </div>
